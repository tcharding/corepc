...
pub const METHODS: &[Method] = &[
    ...
    Method::new_modeled("getchainstates", "GetChainStates", "get_chain_states"),
    ...
    Method::new_modeled("importmempool", "ImportMempool", "import_mempool"),
    ...
    Method::new_modeled("getprioritisedtransactions", "getPrioritisedTransactions", "get_prioritised_transactions"),
    ...
    Method::new_modeled("descriptorprocesspsbt", "DescriptorProcessPsbt", "descriptor_process_psbt"),
    ...
    Method::new_modeled("submitpackage", "SubmitPackage", "submit_package"),
    ...
    Method::new_modeled("gethdkeys", "GetHdKeys", "get_hd_keys"),
