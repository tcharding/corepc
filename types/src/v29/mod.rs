...
pub use crate::{
    v17::{
        ...
        GetBlockVerboseZero, GetChainTips, GetChainTxStatsError,
        GetConnectionCount, GetDifficulty, GetMemoryInfoStats, GetMempoolInfoError,
    ...
    v19::{
        ...
        MempoolEntryFeesError, Softfork, SoftforkType, GetChainTxStats, GetMempoolInfo, GetRpcInfo,
